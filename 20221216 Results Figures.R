...
setEPS()
postscript("LCOE Figure_v6.eps", width = 7.5, height = 5)
par(mar = c(5,7,2,2))
...
text(x=5,y=ATB14.high[1]+25,"Wind Speed Class 14\nNREL ATB Results", col = '#c1272d',adj=c(0,1), cex = 0.8)
text(x=5,y=ATB8.low[1]-1,"Wind Speed Class 8\nNREL ATB Results", col = '#0000a7',adj=c(0,1), cex = 0.8)
text(x=12, y = 220, "Wind Speed Class 14\nModel Results", col = '#c1272d', cex = 0.8, adj = c(0,1))
text(x=12, y = 100, "Wind Speed Class 8\nModel Results", col = '#0000a7', cex = 0.8, adj = c(0,1))

dev.off()

setEPS()
postscript("LCOE Penalty Figure_v2.eps", width = 7.5, height = 5)
par(mar = c(5,7,2,2))
...
text(x=4.9, y = 150, "Wind Speed Class 14", col = '#c1272d', cex = 1, adj = c(1,1))
text(x=4.9, y = 65, "Wind Speed Class 8", col = '#0000a7', cex = 1, adj = c(1,1))
